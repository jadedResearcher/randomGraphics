...
function DirectionalGradualPastels() {
        //has to remember selected color to give to object, not just fill        //values for first object	this.r1 = Math.floor(Math.random() * 155)+100;
	this.g1 = Math.floor(Math.random() * 155)+100;
	this.b1 = Math.floor(Math.random() * 155)+100;
	this.r2 = Math.floor(Math.random() * 155)+100;
	this.g2 = Math.floor(Math.random() * 155)+100;
	this.b2 = Math.floor(Math.random() * 155)+100;

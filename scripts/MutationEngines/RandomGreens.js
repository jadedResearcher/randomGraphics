...
function RandomGreens() {	   this.r1 = Math.floor(Math.random() * 80);
	   this.g1 = Math.floor(Math.random() * 205) + 50;
	   this.b1 = Math.floor(Math.random() * 80);
	   this.r2 = Math.floor(Math.random() * 80);
	   this.g2 = Math.floor(Math.random() * 205) + 50;
	   this.b2 = Math.floor(Math.random() * 80);
